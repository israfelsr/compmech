...
def run_baseline(
    ...
    runner = ExperimentRunner(
        concept_file=concept_file, attribute_file=attribute_file, image_dir=image_dir
    )
    ...
    probe_config = {"probe_type": "logistic", "random_seed": 42}
    ...
    logging.info(
        f"Mean F1 across attributes: {summary['mean_f1_across_attributes']:.4f} ± {summary['std_f1_across_attributes']:.4f}"
    )
