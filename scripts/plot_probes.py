...
def main():
    ...
    if args.save:
        ...
        layer_data = overview_performance(
            results, save_path=f"{args.save}/overview_performance.png"
        )
        ...
        if layer_data:
            ...
            print(
                f"Best performing layer: {best_layer} (F1: {layer_data[best_idx]['mean']:.3f})"
            )
