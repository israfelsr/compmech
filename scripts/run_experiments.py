...
def parse_args():
    ...
    parser.add_argument("--experiment-type", type=str, choices=["single", "comparison", "layer_analysis"],
                       default="single", help="Type of experiment to run")
    parser.add_argument("--use-wandb", action="store_true", 
                       help="Enable W&B logging")
    parser.add_argument("--wandb-project", type=str, default="attribute-probes",
    ...
    parser.add_argument("--cache-dir", type=str, default="external_data/cached_features",
